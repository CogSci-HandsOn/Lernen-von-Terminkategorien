...
def get_features(filename):
	features = extract_features(convert_data(load_data(filename)))
...
def extract_features(data):
	...
	Returns:
		A numpy array of dimension (len(data), 10) containing numeric 
		features.
	...
	for i, sample in enumerate(data):
		...
		# Ordinal of date
		features[i,0] = date.toordinal() - initial_date.toordinal()
		# Year
		features[i,1] = date.year
		# Month of year
		features[i,2] = date.month
		# Day of year
		features[i,3] = date.toordinal() \
			- datetime.date(date.year, 1, 1).toordinal() + 1
		# Day of month
		features[i,4] = date.day
		# Weekday
		features[i,5] = date.weekday()
		# Weekend 1 / week 0
		features[i,6] = features[i,5] == 5 or features[i,5] == 6
		# Week of year
		features[i,7] = np.floor(features[i,3] / 7)
		# Week of month
		features[i,8] = np.floor(features[i,4] / 7)
		# Holiday
		features[i,9] = date in holiday_dates

		## Indirect features concerning the date
