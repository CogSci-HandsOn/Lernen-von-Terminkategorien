...
def get_features2(filename="data"):
	return extract_features2(sorted(convert_data(load_data(filename)))) #we need our data sorted so we can easily acces it later
